...
const Badge: React.FC<BadgeProps> = ({ 
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-4 py-1.5 border rounded-full  text-xxs md:text-xs font-bold tracking-[0.2em] uppercase ${variants[variant]} ${className}`}>
