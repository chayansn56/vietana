...
const BackToTop: React.FC<BackToTopProps> = ({ visible }) => {
  ...
  return (
    <button 
      className={`fixed left-6 md:left-8 z-[300] w-12 h-12 rounded-full border border-brand-gold/35 cursor-pointer bg-[#1E4D45] shadow-strong flex items-center justify-center transition-all duration-500 ease-smooth hover:bg-[#1E4D45]/90 hover:-translate-y-1 hover:scale-105 hover:shadow-heavy
