                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center justify-between gap-4 mb-2">
                                  ...
                                  <Button
                                    ...
                                    className={`!px-2 !py-1 text-text-subtle hover:text-brand-gold ${isSpeakingId === item.id ? 'text-brand-gold animate-pulse bg-brand-gold/10' : ''
                                      }`}
                              ...
                              {isRestaurant ? (
                                <>
                                  <Button
                                    ...
                                    className="!px-0 text-text-subtle hover:text-brand-gold"
                                  ...
                                  <Button
                                    ...
                                    className="!px-0 text-brand-blue hover:text-brand-blue-dark"
                                  >
                                ...
                                <>
                                  ...
                                  <Button
                                    ...
                                    className="!px-0 text-brand-green hover:text-brand-green-dark"
                                  >
                                    Find Places <Icon name="ArrowRight" size={14} />
                                  </Button>
                                </>
                              )}
                            </div>
