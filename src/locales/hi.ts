...
export const hi: TranslationSchema = {
  nav: {
    ...
    essentials: 'वीजा और सेवाएं',
    food: 'फूड गाइड',
    experiences: 'पैकेज',
    journal: 'ट्रैवल गाइड',
    team: 'हमारे बारे में',
    cta: 'अपना मुफ्त ट्रिप प्लान प्राप्त करें',
    flights: 'उड़ानें'
  },
  hero: {
    welcome: 'VIETANA',
    tagline: 'वियतनाम को, अपने तरीके से महसूस करें',
    sub: 'वीज़ा, होटल, भोजन, परिवहन और स्थानीय सहायता - हो ची मिन्ह सिटी से प्रबंधित।',
    support: 'वियतनाम को, अपने तरीके से महसूस करें',
    discover: 'वियतनाम की खोज करें',
    plan: 'अपना मुफ्त ट्रिप प्लान प्राप्त करें'
  },
  services: {
    title: 'हमारी सेवाएँ',
