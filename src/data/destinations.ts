...
export const CITIES: CityDestination[] = [
  {
    ...
    sights: [
      ...
      { id: "hcmc8", name: "Bitexco Financial Tower", image: "https://images.unsplash.com/photo-1550650954-c8c7040212d2?w=800&q=80", description: "A modern skyscraper offering panoramic views from its skydeck." },
      { id: "hcmc9", name: "Jade Emperor Pagoda", image: "https://images.unsplash.com/photo-1596704179377-622f6760b73d?w=800&q=80", description: "An atmospheric, incense-filled Taoist and Buddhist temple." },
      { id: "hcmc10", name: "Binh Tay Market", image: "https://images.unsplash.com/photo-1579704256434-62725fa825b4?w=800&q=80", description: "The massive, bustling wholesale market in the heart of Cholon (Chinatown)." },
    ]
  },
  {
    id: "hanoi",
    ...
    sights: [
      { id: "hanoi1", name: "Hoan Kiem Lake", image: "https://images.unsplash.com/photo-1627918458925-502a5f57fc1c?w=800&q=80", description: "The historical heart of Hanoi, featuring the iconic red Huc Bridge and Ngoc Son Temple." },
      ...
      { id: "hanoi3", name: "Temple of Literature, Hanoi", image: "https://images.unsplash.com/photo-1688647038166-de0b28ec49ba?w=800&q=80", description: "Vietnam's first national university, a tranquil temple dedicated to Confucius." },
      { id: "hanoi4", name: "Ho Chi Minh Mausoleum", image: "https://images.unsplash.com/photo-1591539268804-09852f8295ee?w=800&q=80", description: "The monumental marble resting place of the revolutionary leader." },
      { id: "hanoi5", name: "Imperial Citadel of Thang Long", image: "https://images.unsplash.com/photo-1616866162383-e18e11a3d922?w=800&q=80", description: "A UNESCO World Heritage site showcasing centuries of Vietnamese history." },
      ...
      { id: "hanoi7", name: "Hanoi Street Train", image: "https://images.unsplash.com/photo-1583002272899-7ab0e9a18d1f?w=800&q=80", description: "A narrow residential street where a massive train passes inches from homes." },
      { id: "hanoi8", name: "Tran Quoc Pagoda", image: "https://images.unsplash.com/photo-1600100414408-54e63fc6e4e5?w=800&q=80", description: "The oldest Buddhist temple in Hanoi, beautifully situated on West Lake." },
      { id: "hanoi9", name: "Dong Xuan Market", image: "https://images.unsplash.com/photo-1563266938-166ee5978f87?w=800&q=80", description: "The largest indoor market in Hanoi offering endless local goods." },
      { id: "hanoi10", name: "Thang Long Water Puppet Theatre", image: "https://images.unsplash.com/photo-1615556272847-f274a4ffc04c?w=800&q=80", description: "Experience the traditional art of Vietnamese water puppetry." },
    ]
  },
  {
    id: "sapa",
    ...
    sights: [
      ...
      { id: "sapa2", name: "Cat Cat Village", image: "https://images.unsplash.com/photo-1590202401662-79010abccb83?w=800&q=80", description: "A traditional H'mong village featuring waterfalls and traditional crafts." },
      { id: "sapa3", name: "Muong Hoa Valley", image: "https://images.unsplash.com/photo-1570783307584-c8ed518a4a2b?w=800&q=80", description: "Home to the most spectacular sweeping rice terraces in all of Vietnam." },
      { id: "sapa4", name: "Silver Waterfall", image: "https://images.unsplash.com/photo-1646274488344-0c58a69e3a35?w=800&q=80", description: "A stunning 200m cascading waterfall surrounded by lush pine forests." },
      { id: "sapa5", name: "Love Waterfall", image: "https://images.unsplash.com/photo-1601618600020-f565dbbf0e85?w=800&q=80", description: "A romantic, secluded waterfall located deep within the forest." },
  ...
  },
  {
    ...
    sights: [
      ...
      { id: "halong3", name: "Bai Tu Long Bay", image: "https://images.unsplash.com/photo-1550650954-c8c7040212d2?w=800&q=80", description: "A quieter, more pristine alternative located just east of Ha Long Bay." },
      { id: "halong4", name: "Lan Ha Bay", image: "https://images.unsplash.com/photo-1596704179377-622f6760b73d?w=800&q=80", description: "Stunning karst formations south of Ha Long, offering kayaking and swimming." },
      { id: "halong5", name: "Cat Ba Island", image: "https://images.unsplash.com/photo-1579704256434-62725fa825b4?w=800&q=80", description: "The largest island in the bay, featuring a massive national park and beaches." },
      { id: "halong6", name: "Thien Cung Cave", image: "https://images.unsplash.com/photo-1627918458925-502a5f57fc1c?w=800&q=80", description: "The 'Heavenly Palace Cave', renowned for its intricate stalactites." },
      ...
      { id: "halong8", name: "Cua Van Floating Village", image: "https://images.unsplash.com/photo-1688647038166-de0b28ec49ba?w=800&q=80", description: "One of the largest traditional floating fishing villages in the area." },
    ]
  },
  {
    id: "ninhbinh",
    ...
    sights: [
      ...
      { id: "ninhbinh2", name: "Tam Coc-Bich Dong", image: "https://images.unsplash.com/photo-1591539268804-09852f8295ee?w=800&q=80", description: "Drift down the Ngo Dong river through three magnificent caves." },
      { id: "ninhbinh3", name: "Hang Mua", image: "https://images.unsplash.com/photo-1616866162383-e18e11a3d922?w=800&q=80", description: "Climb 500 stone steps to the famous dragon statue and a breathtaking valley view." },
      { id: "ninhbinh4", name: "Bai Dinh Pagoda", image: "https://images.unsplash.com/photo-1583002272899-7ab0e9a18d1f?w=800&q=80", description: "The largest and most impressive complex of Buddhist temples in Vietnam." },
      { id: "ninhbinh5", name: "Hoa Lu", image: "https://images.unsplash.com/photo-1600100414408-54e63fc6e4e5?w=800&q=80", description: "The ancient 10th-century capital of Vietnam, nestled between limestone mountains." },
      { id: "ninhbinh6", name: "Bich Dong Pagoda", image: "https://images.unsplash.com/photo-1563266938-166ee5978f87?w=800&q=80", description: "An ancient, multi-tiered pagoda built directly into a limestone cave." },
      { id: "ninhbinh7", name: "Thung Nham Bird Park", image: "https://images.unsplash.com/photo-1615556272847-f274a4ffc04c?w=800&q=80", description: "A serene ecological park home to thousands of wild birds and storks." },
      { id: "ninhbinh8", name: "Van Long Nature Reserve", image: "https://images.unsplash.com/photo-1590202401662-79010abccb83?w=800&q=80", description: "A tranquil, mirror-like wetland reserve perfect for peaceful boat rides." },
    ]
  },
  {
    id: "hue",
    ...
    sights: [
      ...
      { id: "hue2", name: "Tomb of Khai Dinh", image: "https://images.unsplash.com/photo-1570783307584-c8ed518a4a2b?w=800&q=80", description: "A dramatic and intricate fusion of traditional Vietnamese and European architecture." },
      { id: "hue3", name: "Tomb of Tu Duc", image: "https://images.unsplash.com/photo-1646274488344-0c58a69e3a35?w=800&q=80", description: "A sprawling, poetic royal tomb set amidst a beautiful pine forest and lake." },
      { id: "hue4", name: "Tomb of Minh Mang", image: "https://images.unsplash.com/photo-1601618600020-f565dbbf0e85?w=800&q=80", description: "A majestic and highly symmetrical royal tomb complex." },
  ...
  },
  {
    ...
    sights: [
      ...
      { id: "danang2", name: "Marble Mountains (Vietnam)", image: "https://images.unsplash.com/photo-1550650954-c8c7040212d2?w=800&q=80", description: "Five marble and limestone hills filled with caves and Buddhist sanctuaries." },
      ...
      { id: "danang4", name: "My Khe Beach", image: "https://images.unsplash.com/photo-1596704179377-622f6760b73d?w=800&q=80", description: "Miles of pristine white sand, perfect for surfing and sunbathing." },
      { id: "danang5", name: "Son Tra Mountain", image: "https://images.unsplash.com/photo-1579704256434-62725fa825b4?w=800&q=80", description: "Lush jungles offering sweeping ocean views and the towering Lady Buddha statue." },
      { id: "danang6", name: "Museum of Cham Sculpture", image: "https://images.unsplash.com/photo-1627918458925-502a5f57fc1c?w=800&q=80", description: "Houses the world's largest collection of ancient Cham artifacts." },
      ...
      { id: "danang8", name: "Hai Van Pass", image: "https://images.unsplash.com/photo-1688647038166-de0b28ec49ba?w=800&q=80", description: "One of the most scenic coastal mountain passes in the world." },
    ]
  },
  {
    id: "hoian",
    ...
    sights: [
      { id: "hoian1", name: "Japanese Covered Bridge", image: "https://images.unsplash.com/photo-1591539268804-09852f8295ee?w=800&q=80", description: "A beautifully ornate 18th-century bridge and temple, the symbol of the town." },
      { id: "hoian2", name: "Hoi An Ancient Town", image: "https://images.unsplash.com/photo-1616866162383-e18e11a3d922?w=800&q=80", description: "Wander through exceptionally preserved streets illuminated by silk lanterns." },
      { id: "hoian3", name: "An Bang Beach", image: "https://images.unsplash.com/photo-1583002272899-7ab0e9a18d1f?w=800&q=80", description: "A laid-back, beautiful beach just a quick bicycle ride from the ancient town." },
      { id: "hoian4", name: "Tra Que Vegetable Village", image: "https://images.unsplash.com/photo-1600100414408-54e63fc6e4e5?w=800&q=80", description: "A peaceful farming village where you can learn traditional Vietnamese agriculture." },
      { id: "hoian5", name: "Thu Bon River", image: "https://images.unsplash.com/photo-1563266938-166ee5978f87?w=800&q=80", description: "Take a wooden rowboat at sunset and release a paper lantern for good luck." },
      { id: "hoian6", name: "Phuc Kien Assembly Hall", image: "https://images.unsplash.com/photo-1615556272847-f274a4ffc04c?w=800&q=80", description: "A stunning, highly decorated temple built by Chinese merchants." },
      { id: "hoian7", name: "Hoi An Night Market", image: "https://images.unsplash.com/photo-1590202401662-79010abccb83?w=800&q=80", description: "A bustling market selling endless lanterns, souvenirs, and street food." },
      { id: "hoian8", name: "Bay Mau Coconut Forest", image: "https://images.unsplash.com/photo-1570783307584-c8ed518a4a2b?w=800&q=80", description: "Spin through the water coconut groves in a traditional circular basket boat." },
    ]
  },
  {
    id: "dalat",
    ...
    sights: [
      ...
      { id: "dalat2", name: "Xuan Huong Lake", image: "https://images.unsplash.com/photo-1646274488344-0c58a69e3a35?w=800&q=80", description: "The picturesque crescent-moon shaped lake at the very center of the city." },
      { id: "dalat3", name: "Datanla Waterfall", image: "https://images.unsplash.com/photo-1601618600020-f565dbbf0e85?w=800&q=80", description: "Ride a thrilling alpine coaster through the pine forest down to the falls." },
      ...
      { id: "dalat9", name: "Linh Phuoc Pagoda", image: "https://images.unsplash.com/photo-1550650954-c8c7040212d2?w=800&q=80", description: "An incredible temple intricately decorated with millions of broken glass pieces." },
    ]
  },
  {
    id: "phuquoc",
    ...
    sights: [
      ...
      { id: "phuquoc2", name: "Phu Quoc Night Market", image: "https://images.unsplash.com/photo-1596704179377-622f6760b73d?w=800&q=80", description: "A paradise for seafood lovers with endless fresh catches grilled to order." },
      { id: "phuquoc3", name: "Hon Thom Cable Car", image: "https://images.unsplash.com/photo-1579704256434-62725fa825b4?w=800&q=80", description: "The world's longest over-sea cable car offering breathtaking aerial island views." },
      { id: "phuquoc4", name: "VinWonders Phu Quoc", image: "https://images.unsplash.com/photo-1627918458925-502a5f57fc1c?w=800&q=80", description: "Vietnam's largest theme park featuring thrilling rides and a massive aquarium." },
      ...
      { id: "phuquoc6", name: "Phu Quoc Prison", image: "https://images.unsplash.com/photo-1688647038166-de0b28ec49ba?w=800&q=80", description: "A sobering historical site detailing the island's dark history during the war." },
      { id: "phuquoc7", name: "Vinpearl Safari Phu Quoc", image: "https://images.unsplash.com/photo-1591539268804-09852f8295ee?w=800&q=80", description: "Vietnam's largest semi-wildlife conservation park." },
      { id: "phuquoc8", name: "Suoi Tranh Waterfall", image: "https://images.unsplash.com/photo-1616866162383-e18e11a3d922?w=800&q=80", description: "A gentle, picturesque waterfall surrounded by lush jungle and walking trails." },
    ]
  },

  {
    id: "phongnha",
    name: "Phong Nha",
    coverImage: "https://images.unsplash.com/photo-1583002272899-7ab0e9a18d1f?w=800&q=80",
    ...
    sights: [
      { id: "phongnha1", name: "Son Doong Cave", image: "https://images.unsplash.com/photo-1600100414408-54e63fc6e4e5?w=800&q=80", description: "The largest natural cave in the world, requiring an expedition to explore." },
      { id: "phongnha2", name: "Paradise Cave", image: "https://images.unsplash.com/photo-1563266938-166ee5978f87?w=800&q=80", description: "A brilliantly illuminated, accessible cave featuring spectacular stalactites." },
      { id: "phongnha3", name: "Dark Cave", image: "https://images.unsplash.com/photo-1615556272847-f274a4ffc04c?w=800&q=80", description: "Zipline into the entrance and navigate through the mud baths." },
      { id: "phongnha4", name: "Phong Nha Cave", image: "https://images.unsplash.com/photo-1590202401662-79010abccb83?w=800&q=80", description: "A beautiful river cave explored by traditional wooden dragon boats." },
      ...
      { id: "phongnha6", name: "Mooc Spring", image: "https://images.unsplash.com/photo-1570783307584-c8ed518a4a2b?w=800&q=80", description: "A vibrant emerald eco-trail perfect for kayaking and swimming." },
    ]
  },
  {
    id: "muine",
    name: "Mui Ne",
    coverImage: "https://images.unsplash.com/photo-1646274488344-0c58a69e3a35?w=800&q=80",
    ...
    sights: [
      { id: "muine1", name: "White Sand Dunes", image: "https://images.unsplash.com/photo-1601618600020-f565dbbf0e85?w=800&q=80", description: "Vast, Sahara-like dunes best explored by ATV at sunrise." },
  ...
  },
  {
    id: "cantho",
    name: "Can Tho",
    coverImage: "https://images.unsplash.com/photo-1531737212413-667205e1cda7?w=800&q=80",
    ...
    sights: [
      { id: "cantho1", name: "Cai Rang Floating Market", image: "https://images.unsplash.com/photo-1550650954-c8c7040212d2?w=800&q=80", description: "The largest floating market in the delta, best visited at the crack of dawn." },
      { id: "cantho2", name: "Binh Thuy Ancient House", image: "https://images.unsplash.com/photo-1596704179377-622f6760b73d?w=800&q=80", description: "A beautiful fusion of French and Vietnamese architecture from 1870." },
      { id: "cantho3", name: "Ninh Kieu Wharf", image: "https://images.unsplash.com/photo-1579704256434-62725fa825b4?w=800&q=80", description: "A vibrant riverside promenade filled with night markets and restaurants." },
      { id: "cantho4", name: "Con Son Islet", image: "https://images.unsplash.com/photo-1627918458925-502a5f57fc1c?w=800&q=80", description: "A tranquil island community offering community-based tourism and fruit orchards." },
      ...
      { id: "cantho6", name: "Ba Bo Flower Village", image: "https://images.unsplash.com/photo-1688647038166-de0b28ec49ba?w=800&q=80", description: "Acres of vivid flowers grown traditionally for the Lunar New Year." },
    ]
  },
  {
    id: "hagiang",
    name: "Ha Giang",
    coverImage: "https://images.unsplash.com/photo-1591539268804-09852f8295ee?w=800&q=80",
    ...
    sights: [
      ...
      { id: "hagiang2", name: "Dong Van Karst Plateau", image: "https://images.unsplash.com/photo-1616866162383-e18e11a3d922?w=800&q=80", description: "A UNESCO Global Geopark featuring profound geological heritage." },
      { id: "hagiang3", name: "Lung Cu Flag Tower", image: "https://images.unsplash.com/photo-1583002272899-7ab0e9a18d1f?w=800&q=80", description: "The northernmost point of Vietnam, marking the border with China." },
      { id: "hagiang4", name: "Nho Que River", image: "https://images.unsplash.com/photo-1600100414408-54e63fc6e4e5?w=800&q=80", description: "A stunning turquoise river weaving through the deep Tu San Canyon." },
      { id: "hagiang5", name: "Hmong King's Palace", image: "https://images.unsplash.com/photo-1563266938-166ee5978f87?w=800&q=80", description: "A unique, century-old timber palace belonging to the former Hmong royalty." },
      { id: "hagiang6", name: "Quan Ba Heaven Gate", image: "https://images.unsplash.com/photo-1615556272847-f274a4ffc04c?w=800&q=80", description: "A sweeping viewpoint overlooking the famous 'Fairy Bosom' twin mountains." },
    ]
  },
  {
    id: "vungtau",
    name: "Vung Tau",
    coverImage: "https://images.unsplash.com/photo-1590202401662-79010abccb83?w=800&q=80",
    ...
    sights: [
      { id: "vungtau1", name: "Christ of Vung Tau", image: "https://images.unsplash.com/photo-1570783307584-c8ed518a4a2b?w=800&q=80", description: "A massive statue of Jesus atop Mount Nho, rivaling Rio's Christ the Redeemer." },
      { id: "vungtau2", name: "Vung Tau Lighthouse", image: "https://images.unsplash.com/photo-1646274488344-0c58a69e3a35?w=800&q=80", description: "A French-built lighthouse offering panoramic 360-degree views of the city." },
      { id: "vungtau3", name: "Back Beach (Bai Sau)", image: "https://images.unsplash.com/photo-1601618600020-f565dbbf0e85?w=800&q=80", description: "The longest and most popular beach in the city for swimming and surfing." },
