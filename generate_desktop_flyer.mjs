...
async function generateFlyer() {
      ...
      <div class="flyer-container">
        ...
        <div class="conversion-row">
          ...
          <div class="action-box">
            <h5>Book Now (Vietnam Office Support)</h5>
            <div class="hotline">+84 90 243 4006</div>
  ...
  const destPath = '/Users/chayansoni/Desktop/vietana_hcmc_phu_quoc_flyer.png';
  await page.screenshot({ path: destPath, type: 'png' });

  console.log(`Flyer PNG generated successfully at: ${destPath}`);
  await browser.close();
}
